...
void record_roi_stats(uint32_t cpu, CACHE *cache)
{
	...
	cache->roi_overlap_miss[cpu][i] = cache->sim_overlap_miss[cpu][i];
...
{
    uint64_t TOTAL_ACCESS = 0, TOTAL_HIT = 0, TOTAL_MISS = 0, TOTAL_PURE_MISS = 0;
    uint64_t TOTAL_OVERLAP_MISS = 0;
    for (uint32_t i=0; i<NUM_TYPES; i++) {
        TOTAL_ACCESS += cache->roi_access[cpu][i];
        TOTAL_HIT += cache->roi_hit[cpu][i];
        TOTAL_MISS += cache->roi_miss[cpu][i];
	TOTAL_OVERLAP_MISS += cache->roi_overlap_miss[cpu][i];
	...
	<< "Core_" << cpu << "_" << cache->NAME << "_total_overlap_miss " << TOTAL_OVERLAP_MISS << endl
	...
	<< "Core_" << cpu << "_" << cache->NAME << "_active_hit_miss_overlap_cycles " << cache->active_hit_cycles.size() + cache->total_active_hit_cycles + cache->active_miss_cycles.size() + cache->total_active_miss_cycles - cache->active_cycles.size() - cache->total_active_cycles<< endl
	...
	<< "Core_" << cpu << "_" << cache->NAME << "_active_cycles_per_core " << cache->total_active_cycles_per_core[cpu] + cache->active_cycles_per_core[cpu].size() << endl
	<< "Core_" << cpu << "_" << cache->NAME << "_active_hit_cycles_per_core " << cache->total_active_hit_cycles_per_core[cpu] + cache->active_hit_cycles_per_core[cpu].size() << endl
	<< "Core_" << cpu << "_" << cache->NAME << "_active_miss_cycles_per_core " << cache->total_active_miss_cycles_per_core[cpu] + cache->active_miss_cycles_per_core[cpu].size() << endl
	<< "Core_" << cpu << "_" << cache->NAME << "_active_pure_miss_cycles_per_core " << (cache->total_active_miss_cycles_per_core[cpu] + cache->active_miss_cycles_per_core[cpu].size()) - (cache->total_active_hit_cycles_per_core[cpu] + cache->active_hit_cycles_per_core[cpu].size() + cache->total_active_miss_cycles_per_core[cpu] + cache->active_miss_cycles_per_core[cpu].size() - (cache->total_active_cycles_per_core[cpu] + cache->active_cycles_per_core[cpu].size())) << endl
	<< "Core_" << cpu << "_" << cache->NAME << "_hit_miss_overlap_cycles_per_core " << (cache->total_active_hit_cycles_per_core[cpu] + cache->active_hit_cycles_per_core[cpu].size()) + (cache->total_active_miss_cycles_per_core[cpu] + cache->active_miss_cycles_per_core[cpu].size()) - (cache->total_active_cycles_per_core[cpu] + cache->active_cycles_per_core[cpu].size()) << endl
	<< "Core_" << cpu << "_" << cache->NAME << "_camat_per_core " << (1.0*(cache->total_active_cycles_per_core[cpu] + cache->active_cycles_per_core[cpu].size())) / TOTAL_ACCESS << endl
	<< endl;
...
void reset_cache_stats(uint32_t cpu, CACHE *cache)
{
	...
	cache->sim_overlap_miss[cpu][i] = 0;
    ...
    cache->active_hit_cycles_per_core.clear();
    cache->active_miss_cycles_per_core.clear();
    cache->active_cycles_per_core.clear();
    
    cache->total_active_hit_cycles_per_core[cpu] = 0;
    cache->total_active_miss_cycles_per_core[cpu] = 0;
    cache->total_active_cycles_per_core[cpu] = 0;
